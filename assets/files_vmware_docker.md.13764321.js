import{_ as s,c as n,o as a,a as l}from"./app.73c3d265.js";const D=JSON.parse('{"title":"yum-util \u63D0\u4F9Byum-config-manager\u529F\u80FD\uFF0C\u53E6\u5916\u4E24\u4E2A\u662Fdevicemapper\u9A71\u52A8\u4F9D\u8D56\u7684","description":"","frontmatter":{},"headers":[],"relativePath":"files/vmware/docker.md"}'),p={name:"files/vmware/docker.md"},e=l(`<p>\u6559\u7A0B\uFF1A<a href="https://www.runoob.com/docker/docker-run-command.html" target="_blank" rel="noopener noreferrer">https://www.runoob.com/docker/docker-run-command.html</a></p><p>docker\u5728centros7\u5B89\u88C5</p><div class="language-shell"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">su root</span></span>
